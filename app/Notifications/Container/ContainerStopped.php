...
class ContainerStopped extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $mail->subject("Helix Claude: A resource  has been stopped unexpectedly on {$this->server->name}");
    ...
    {
        $message = "Helix Claude: A resource ($this->name) has been stopped unexpectedly on {$this->server->name}";
        $payload = [
            'message' => $message,
        ];
        if ($this->url) {
