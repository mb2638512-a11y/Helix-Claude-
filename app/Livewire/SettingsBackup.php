...
class SettingsBackup extends Component
{
    ...
    public function mount()
    {
        ...
        $this->database = StandalonePostgresql::whereName('HelixClaude-db')->first();
    ...
    public function addHelixClaudeDatabase()
    {
        try {
            ...
            $out = instant_remote_process(['docker inspect HelixClaude-db'], $server);
            ...
            $this->database = StandalonePostgresql::create([
                'id' => 0,
                'name' => 'HelixClaude-db',
                'description' => 'HelixClaude database',
