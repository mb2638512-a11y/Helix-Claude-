...
use App\Actions\HelixClaudeTask\RunRemoteProcess;
...
class HelixClaudeTask implements ShouldBeEncrypted, ShouldQueue
{
    ...
    {
        Log::channel('scheduled-errors')->error('HelixClaudeTask permanently failed', [
            'job' => 'HelixClaudeTask',
