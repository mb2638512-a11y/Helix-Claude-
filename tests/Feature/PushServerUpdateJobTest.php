        ...
        'containers' => [
            [
                ...
                'labels' => [
                    ...
                    'Helix Claude.serviceId' => (string) $service->id,
                    'Helix Claude.service.subType' => 'application',
                    'Helix Claude.service.subId' => '',
                ],
            ],
        ],
    ];
        ...
        'containers' => [
            [
                ...
                'labels' => [
                    ...
                    'Helix Claude.serviceId' => (string) $service->id,
                    'Helix Claude.service.subType' => 'application',
                    'Helix Claude.service.subId' => (string) $serviceApp->id,
