...
test('keydb config chown command is added when keydb_conf is set', function () {
    ...
    $action->configuration_dir = '/data/HelixClaude/databases/test-uuid';
    $action->commands = [];
    ...
    expect($action->commands)->toContain('chown 999:999 /data/HelixClaude/databases/test-uuid/keydb.conf');
});
