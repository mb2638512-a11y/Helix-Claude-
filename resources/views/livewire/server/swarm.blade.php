<div>
    <x-slot:title>
        {{ data_get_str($server, 'name')->limit(10) }} > Swarm | Helix Claude
    </x-slot>
        ...
        <div class="w-full">
            <div>
                ...
                <div class="pb-4">Read the docs <a class='underline dark:text-white'
                        href='https://Helix Claude.io/docs/knowledge-base/docker/swarm' target='_blank'>here</a>.
                </div>
            </div>
            ...
            <div class="w-96">
                @if ($server->settings->is_swarm_worker)
                    <x-forms.checkbox disabled instantSave type="checkbox" id="isSwarmManager"
                        helper="For more information, please read the documentation <a class='dark:text-white' href='https://Helix Claude.io/docs/knowledge-base/docker/swarm' target='_blank'>here</a>."
