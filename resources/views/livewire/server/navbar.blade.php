        ...
        <x-slot:content>
            @if ($server->id === 0)
                <div class="mb-4 p-3 text-sm bg-warning/10 border border-warning/30 rounded-lg text-warning">
                    <span class="font-semibold">Note:</span> This is the localhost server where HelixClaude runs.
            ...
            <div>
                @if ($server->proxySet())
                    @if ($proxyStatus === 'running')
                            ...
                            'All resources hosted on HelixClaude will be unavailable during the restart.',
                            ...
                            'The HelixClaude proxy will be stopped.',
                            'All resources hosted on HelixClaude will be unavailable.',
