    ...
    <x-slot:title>
        ...
        <div x-data="{ activeTab: window.location.hash ? window.location.hash.substring(1) : 'general' }"
            ...
            <form wire:submit='submit' class="flex flex-col">
                ...
                <div class="pb-4">General configuration for your HelixClaude instance.</div>
                    ...
                    <div class="flex flex-wrap items-end gap-2">
                        <div class="flex gap-2 md:flex-row flex-col w-full">
                            <x-forms.input canGate="update" :canResource="$settings" id="fqdn" label="URL"
                                ...
                                placeholder="https://HelixClaude.yourdomain.com" />
                            <x-forms.input canGate="update" :canResource="$settings" id="instance_name" label="Name" placeholder="HelixClaude"
                                helper="Custom name for your HelixClaude instance, shown in the URL." />
                            ...
                            init() {
                                ...
                                <div class="flex items-center mb-1">
                                    <label for="instance_timezone">Instance
                                        Timezone</label>
                                    <x-helper class="ml-2"
                                        helper="Timezone for the HelixClaude instance. This is used for the update check and automatic update frequency." />
                                </div>
                                <div class="relative">
                        ...
                        <div class="flex gap-2 md:flex-row flex-col w-full">
                            <x-forms.input canGate="update" :canResource="$settings" id="public_ipv4" type="password" label="Instance's Public IPv4"
                                helper="Enter the IPv4 address of the instance.<br><br>It is useful if you have several IPv4 addresses and HelixClaude could not detect the correct one."
                            ...
                            <x-forms.input canGate="update" :canResource="$settings" id="public_ipv6" type="password" label="Instance's Public IPv6"
                                helper="Enter the IPv6 address of the instance.<br><br>It is useful if you have several IPv6 addresses and HelixClaude could not detect the correct one."
                        ...
                        @if(isDev())
                            <x-forms.input canGate="update" :canResource="$settings" id="dev_helper_version" label="Dev Helper Version (Development Only)"
                                helper="Override the default HelixClaude-helper image version. Leave empty to use the default version from config ({{ config('constants.HelixClaude.helper_version') }}). Examples: 1.0.11, latest, dev"
                                placeholder="{{ config('constants.HelixClaude.helper_version') }}" />
                        @endif
                </div>
            </form>
            ...
            <x-domain-conflict-modal :conflicts="$domainConflicts" :showModal="$showDomainConflictModal"
                ...
                <x-slot:consequences>
                    <ul class="mt-2 ml-4 list-disc">
                        <li>The HelixClaude instance domain will conflict with existing resources</li>
                        <li>SSL certificates might not work correctly</li>
                        <li>Routing behavior will be unpredictable</li>
                        <li>You may not be able to access the HelixClaude dashboard properly</li>
                    </ul>
                </x-slot:consequences>
