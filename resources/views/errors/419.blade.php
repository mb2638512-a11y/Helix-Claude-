    ...
    <div>
        ...
        <details class="mt-6 text-sm dark:text-neutral-400 text-neutral-600">
            ...
            <ul class="mt-2 ml-4 list-disc space-y-1">
                <li>Set your domain in <strong>Settings &rarr; FQDN</strong> to match the URL you use to access Helix Claude.</li>
                <li>Cloudflare users: disable <strong>Browser Integrity Check</strong> and <strong>Under Attack Mode</strong> for your Helix Claude domain, as these can interrupt login sessions.</li>
                <li>If you can still access Helix Claude via <code>localhost</code>, log in there first to configure your FQDN.</li>
            </ul>
        </details>
